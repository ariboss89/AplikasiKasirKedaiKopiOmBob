...
public class FormPengaturan extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            rs = st.executeQuery("SELECT *FROM tb_pengguna WHERE username = '"+txtUsername.getText()+"' AND password = '"+jPasswordField1.getText()+"'");
            if(rs.next()){
                String passwordBaru = jPasswordField2.getText().trim();
                pd.Update(passwordBaru, passwordBaru);
            }
            else{
                JOptionPane.showMessageDialog(null, "Password Lama Salah, Silahkan Ulangi !! ");
